    ...
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-white">
      ...
      <section className="container mx-auto px-4 pt-20 pb-32">
        <div className="flex flex-col items-center text-center space-y-8">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-zinc-900 max-w-4xl">
            Shorten Your Links,
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-white border-zinc-200 shadow-sm">
            <CardHeader>
              ...
              <CardTitle className="text-zinc-900">Easy Link Shortening</CardTitle>
              <CardDescription>
          ...
          <Card className="bg-white border-zinc-200 shadow-sm">
            <CardHeader>
              ...
              <CardTitle className="text-zinc-900">Secure & Private</CardTitle>
              <CardDescription>
          ...
          <Card className="bg-white border-zinc-200 shadow-sm">
            <CardHeader>
              ...
              <CardTitle className="text-zinc-900">Lightning Fast</CardTitle>
              <CardDescription>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center space-y-4">
            ...
            <h3 className="text-xl font-semibold text-zinc-900">Sign Up</h3>
          ...
          <div className="text-center space-y-4">
            ...
            <h3 className="text-xl font-semibold text-zinc-900">Shorten</h3>
            <p className="text-zinc-600">
          ...
          <div className="text-center space-y-4">
            ...
            <h3 className="text-xl font-semibold text-zinc-900">Share</h3>
            <p className="text-zinc-600">
